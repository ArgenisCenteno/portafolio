...
import contactImg from "../assets/space.png";
import 'animate.css';
...
const Contact = () => {
    ...
    const formInitialDetails = {
      ...
      const [buttonText, setButtonText] = useState('Envíar');
      ...
      const handleSubmit = async (e) => {
        ...
        if (result.code == 200) {
          ...
          setStatus({ succes: false, message: 'Ha ocurrido un error, intente más tarde :('});
        }
      };
            ...
            {({ isVisible }) =>
              ...
              <form onSubmit={handleSubmit}>
                <Row>
                  ...
                  <Col size={12} sm={6} className="px-1">
                    <input type="tel" value={formDetails.phone} placeholder="Telefono" onChange={(e) => onFormUpdate('phone', e.target.value)} required/>
                  </Col>
                  <Col size={12} className="px-1">
                    ...
                    <button type="submit" disabled><span>{buttonText}</span></button>
                  </Col>
